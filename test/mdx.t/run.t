Test that opam-monorepo can generate a lockfile and build mdx.
  ...
  ==> Wrote lockfile with 18 entries to $TESTCASE_ROOT/mdx-test.opam.locked. You can now run opam monorepo pull to fetch their sources.
  $ opam-monorepo pull
  ==> Using lockfile $TESTCASE_ROOT/mdx-test.opam.locked
